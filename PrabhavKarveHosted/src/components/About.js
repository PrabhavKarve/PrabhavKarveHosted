...
const About = () => {
    ...
    <section className="about" id="about">
        ...
        <div className="education">
                <h3>___________ Timeline ___________</h3>
                <div className="timeline-item">
                    ...
                    <div className="content">
                        <h4>MS, Computer Science (3.5/4)</h4>
                ...
                <div className="timeline-item">
                    ...
                    <div className="content">
                        <h4>Data Engineering Associate</h4>
                        <p>Accenture</p>
                ...
                <div className="timeline-item">
                    ...
                    <div className="content">
                        <h4>BE, Information Technology (8.06 / 10)</h4>
        ...
        <div className="skills">
                <h3>___________ Skills ___________</h3>
